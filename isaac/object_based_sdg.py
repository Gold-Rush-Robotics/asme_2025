...
if env_url:
    ...
    distant_light.CreateAttribute("inputs:intensity", Sdf.ValueTypeNames.Float).Set(100.0)
...
def apply_velocities_towards_target(assets, target=(0, 0, 0)):
    for prim in assets:
        ...
        strength = 0.0 #random.uniform(0.1, 1.0)#FIX
...
with rep.trigger.on_custom_event(event_name="randomize_lights"):
    lights = rep.create.light(
        ...
        intensity=rep.distribution.normal(5000, 500),
